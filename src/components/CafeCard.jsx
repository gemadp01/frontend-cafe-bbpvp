...
function CardCafe(props) {
  ...
  return (
    <Link to={{ pathname: `/cafe-detail/${id}` }}>
      <div className="flex flex-col flex-wrap sm:flex-row border items-center border-bgColor-2 py-1 px-1 max-w- text-center sm:text-left rounded">
